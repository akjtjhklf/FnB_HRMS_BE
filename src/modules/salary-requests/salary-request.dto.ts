...
export const createSalaryRequestSchema = z.object({
  employee_id: z.uuid(),
  current_scheme_id: z.uuid().nullable().optional(),
  proposed_scheme_id: z.uuid().nullable().optional(),
...
export const salaryRequestResponseSchema = z.object({
  id: z.uuid(),
  employee_id: z.uuid(),
  current_scheme_id: z.uuid().nullable(),
  proposed_scheme_id: z.uuid().nullable(),
